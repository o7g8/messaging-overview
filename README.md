...
| Routing                          | N                                   | Y (via filtering) (62)                              | Y (63)                                          | Y (b/w shards using partition key) (64) | Y (65)                                                  | N (66)                                            | Y (67)                                                | Y (with Apache Camel) (68, 69)                                                                     | Y (PubSub pattern matching) (70) / N (Streams)            |
...
| Replay                           | N (2)                               | N (2)                                               | Y (3)                                           | Y                                       | N                                                       | Y                                                 | N (25)                                                | N (27)                                                                                             | Y (Streams) / N (PubSub)                                  |
| P2P vs Pub/Sub                   | P2P                                 | Pub/Sub                                             | Pub/Sub                                         | Pub/Sub                                 | Pub/Sub                                                 | Pub/Sub                                           | Pub/Sub                                               | Pub/Sub                                                                                            | *                                                         |
| Push vs Pull                     | Pull                                | Push                                                | Push                                            | Pull                                    | Push                                                    | Pull                                              | Both                                                  | Both                                                                                               | Pull (Streams) (74) / Pull (PubSub) (73)                  |
